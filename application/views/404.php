...
<head>
<meta charset="utf-8">
<title>Tools Ngodeeid - 404 Page Not Found</title>
...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">Halaman Tidak Ditemukan</h1>
      <p class="message__text">Maaf, halaman yang Anda cari tidak ditemukan. Tautan yang Anda ikuti mungkin rusak atau tidak ada lagi. Silakan coba lagi, atau kembali ke Home.</p>
    </div>
    <div class="error__nav e-nav">
      <a href="<?=base_url('')?>" class="e-nav__link"></a>
    </div>
  </div>
  <!-- END Content -->
